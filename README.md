A Python desktop application with a PyQt5 GUI for exploring and analyzing Yelp business data, backed by a PostgreSQL database of 11,481 businesses.<br>
Features:
...
The app’s main view lets users narrow down from state -> city -> ZIP code, filter by category, and see results update across four linked panels (ZIP code stats, top categories, business listings, and popularity/success rankings).<br>
Tech stack:
- Language: Python
- GUI framework: PyQt5
- Database: PostgreSQL
- Entry point: Milestone3App.py<br>
Running the project:
